...
/// <summary>
/// Default configuration values for Azure tests.
/// </summary>
public static class AzureTestDefaults
{
    /// <summary>
    /// Default timeout for initial connection attempts to Azure services.
    ...
    /// <summary>
    /// Default timeout for Azure operations during tests.
    /// </summary>
