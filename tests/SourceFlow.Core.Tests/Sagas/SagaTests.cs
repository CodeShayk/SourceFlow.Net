...
namespace SourceFlow.Core.Tests.Sagas
{
    ...
    public class SagaTests
    {
        ...
        {
            public TestSaga() : base(new Mock<ICommandPublisher>().Object, new Mock<IEventQueue>().Object, new Mock<IRepository>().Object, new Mock<ILogger<ISaga>>().Object)
            {
            }

            public TestSaga(ICommandPublisher publisher, IEventQueue queue, IRepository repo, ILogger<ISaga> logger):base(publisher, queue, repo, logger)
            {
        ...
        public async Task Publish_ValidCommand_DelegatesToPublisher()
        {
            ...
            var saga = new TestSaga(publisherMock.Object, new Mock<IEventQueue>().Object, new Mock<IRepository>().Object, new Mock<ILogger<ISaga>>().Object);
        ...
        public async Task Raise_ValidEvent_DelegatesToQueue()
        {
            ...
            var saga = new TestSaga(new Mock<ICommandPublisher>().Object, queueMock.Object, new Mock<IRepository>().Object, new Mock<ILogger<ISaga>>().Object);
