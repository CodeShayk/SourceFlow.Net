...
namespace SourceFlow.ConsoleApp.Sagas
{
                               ...
                               IHandles<ActivateAccount>
    {
        ...
        public async Task Handle(IEntity entity, CreateAccount command)
        {
        ...
        public async Task Handle(IEntity entity, ActivateAccount command)
        {
        ...
        public async Task Handle(IEntity entity, DepositMoney command)
        {
        ...
        public async Task Handle(IEntity entity, WithdrawMoney command)
        {
        ...
        public async Task Handle(IEntity entity, CloseAccount command)
        {
